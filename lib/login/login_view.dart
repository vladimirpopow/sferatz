import 'package:sferatz/login/login_view_model.dart';
    ...
    return Form(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        TextFormField(
          ...
          decoration: inputDecoration('Login', Icons.person),
        ),
        SizedBox(
          height: 8,
        ),
        ...
        ElevatedButton(
          onPressed: () async {
            if (formKey.currentState?.validate() ?? false) {
              await _viewModel.loginUser(loginCtr.text, passwordCtr.text);
            }
          },
          child: Text('Login'),
        ),
